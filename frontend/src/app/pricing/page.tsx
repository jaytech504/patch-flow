  ...
  const plans: PricingPlan[] = [
    {
      ...
      features: [
        ...
        { title: "3 Chaos Scans / month (with Auto-PRs)", included: true },
        { title: "All 18 Chaos Failure Modes", included: true },
        { title: "7-Day Log Retention", included: true },
        { title: "Live SDK Crash Auto-Patches", included: false, footnote: "Alerts & logs only — upgrade to auto-patch" },
    ...
    },
    {
      ...
      description: "Live site auto-patching, pre-merge compiler build validation, and 5 monitored sites.",
      buttonText: "Upgrade to Pro",
      buttonHref: "/login",
      popular: true,
      features: [
        { title: "5 Monitored Sites (SDK)", included: true },
        { title: "100 Live SDK Auto-Patches / month", included: true },
